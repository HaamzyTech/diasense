    ...
    <div className="w-full max-w-[480px] space-y-8">
      <div className="space-y-2 text-center md:text-left">
        ...
        <p className="max-w-sm text-base font-medium text-on-surface-variant">
          Register with a username or email and password to create your account
          and enter the clinic workspace.
        </p>
      </div>
        ...
        <div className="space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-sm text-on-surface-variant">
              Choose a username, add an email if you want, and set a password.
            </p>
          </div>
          <SignupForm />
        </div>
